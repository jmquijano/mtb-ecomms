...
class PaypalCallback extends React.Component<any, IState> {
    ...
    componentDidMount() {
        ...
        if (params.get("state") == "cancel") {
            this.setState({
                isCancelled: true
            });
        }

        fetch(ApiConfigProvider.BaseUrl.Paypal + "payment/capture", {
            method: 'POST',
            body: JSON.stringify({
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <TitleComponent title={'Paypal Payment Verification'} />
                <>
                    ...
                    <div className={(this.state.loaderState ? 'd-flex' : 'd-none') +' align-items-center justify-content-center'} style={{
                        ...
                        <div className={'container text-center'}>
                            <div className={'d-flex align-items-center justify-content-center'}>
                                ...
                                <span className={'mtb-checkout-loading-text ms-3'}>Connecting to PayPal</span>
                            </div>
                                    ...
                                    <div className={'col-12'} id={'orderDetailsPrint'}>
                                        <div className={'card px-3 py-3 mx-auto'} style={{
                                            ...
                                            <div className={'row gy-3 mt-5 p-0'}>
                                                {this.state.paypalData?.map((data, i) => {
                                                    return(
                                ...
                                <div className={'row gy-3 text-center'}>
                                    ...
                                    <div className={'col-12'}>
                                        <span className={'mtb-checkout-text text-center'} style={{
                                            ...
                                            {(params.get("state") === "cancelled" ? 'Payment has been cancelled.' : this.state.paymentMessage)}
                                        </span>
                                    </div>
                                    <div className={'col-12'}>
                                        <span onClick={() => {
